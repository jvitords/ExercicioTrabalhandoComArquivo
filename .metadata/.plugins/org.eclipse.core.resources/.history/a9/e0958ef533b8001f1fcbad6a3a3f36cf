...
public class Program {
	...
	public static void main(String[] args) {
		...
		boolean criacaoDaPasta =  new File(caminhoDaPasta + "\\PastaCSV_CriadoPorMim").mkdir(); // "mkdir" cria uma nova pasta
		...
		File arquivoCSV = new File(caminhoParaCriacaoDoArquivo + "\\produtoCSV_criadoPorMim.csv");
